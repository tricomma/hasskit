...
//          log.d("onWebViewCreated currentUrl $currentUrl");
//          if (webController != null) webController = controller;
//        },
...
class WebView extends StatefulWidget {
  ...
  final double height;
  WebView({@required this.currentUrl, @required this.height});
      ...
      child: Stack(
        children: <Widget>[
          InAppWebView(
            ...
            onWebViewCreated: (InAppWebViewController controller) {
              print("onWebViewCreated currentUrl ${widget.currentUrl}");
...
//              this.url = url;
            ...
            onProgressChanged:
              ...
              setState(() {
                print(
                    "onProgressChanged progress $progress currentUrl ${widget.currentUrl}");
                showSpin = false;
